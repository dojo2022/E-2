...
<body>
	...
	<div class="">
	<p>身長<input type="text" value="170">cm</p>
	<p>体重<input type="text" value="60">kg</p>
	</div>
	...
	<tr>
	<td>18.5未満</td><td>低体重(やせ)</td>
	</tr>
	<tr>
	<td>18.5～25未満</td><td>普通体重</td>
	</tr>
	<tr>
	<td>25～30未満</td><td>肥満(1度)</td>
	</tr>
	<tr>
	<td>30～35未満</td><td>肥満(2度)</td>
	</tr>
	<tr>
	<td>35～40未満</td><td>肥満(3度)</td>
	</tr>
	<tr>
	<td>40以上</td><td>肥満(4度)</td>
	</tr>
	</table>
