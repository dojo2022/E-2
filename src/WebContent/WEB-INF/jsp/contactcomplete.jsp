...
<link rel="stylesheet" type="text/css"
	href="/healthcare/css/contactcomplete.css">
</head>
<body>
	<div class="wrapper">
		<header>
		...
		<div class="text">
			<p></p>
			<p class="boxes regi">
				お問い合わせが完了しました。<br> 内容を確認の上、改めてご連絡いたします。
			</p>
			<img class="image" src="/healthcare/img/お問い合わせ完了.png">
		</div>
		<div class="button">
			<input class="buttoncolor" type="button"
				onclick="location.href='/healthcare/ContactServlet'"
				value="お問い合わせ画面に戻る"> <input class="buttoncolor"
				type="button" onclick="location.href='/healthcare/MypageServlet'"
				value="マイページに戻る">
		</div>
		<footer class="footer">
