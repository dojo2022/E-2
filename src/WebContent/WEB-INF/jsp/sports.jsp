...
<h1>運動計算</h1>
<p>計算式<br>
消費カロリー(kcal)＝メッツ*体重(kg)*(運動時間*1.05)<br>
メッツ値は運動による消費エネルギー量が、安静時の何倍にあたるかを示す値です。<br>
メッツ値は厚生労働省の「健康づくりのための身体活動基準2013」の値を使用しています。</p>

<p><input type="radio" name="radio" id="radio1"><label for="radio1">生活</label><input type="radio" name="radio" id="radio2"><label for="radio2">運動</label></p>
<select name="life">
	<option value="1922">あいうえお</option>
</select>
<p>時間<input type="text" value="">分</p>
<p>体重<input type="text" value="">kg</p>
<input type="button" value="計算">
<input type="button" value="クリア">
<p>運動強度<input type="text" value="">(メッツ)</p>
<p>消費カロリー<input type="text" value="">kcal</p>
<select name="year">
